...
## Another description on how to use these Ansible playbooks to boot you own out-of-cloud cluster can be read at https://dzone.com/articles/anatomy-of-a-high-availability-kubernetes-cluster.
